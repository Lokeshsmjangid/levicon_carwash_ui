...
import 'customer_category_stations_screen.dart';
...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  List<StationCategory> categoryList = [
    StationCategory(
        imgPath: AppAssets.basicWashIcon, categoryName: 'basic wash'),
    StationCategory(
        imgPath: AppAssets.detailingIcon, categoryName: 'detailing'),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          addText500('Home', fontSize: 16, color: Colors.white),
                          Row(
                            children: [
                              Image.asset(AppAssets.locationIcon,
                                  color: AppColors.blueColor, height: 14),
                              addWidth(4),
                              ...
                              addWidth(4),
                              Image.asset(AppAssets.dropDownArrow, height: 10,
                                width: 10,
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        addText500('Service', fontSize: 16,
                        ...
                        GestureDetector(
                            ...
                            child: addText500('See more', fontSize: 16,
                                color: AppColors.primaryColor)),
                        Icon(
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          String name = categoryList[index].categoryName
                              .toString();
                          return Column(
                            children: [
                              Container(
                                  ...
                                  child: Image.asset(icon).marginAll(14))
                                  .marginOnly(bottom: 4),
                              addText400(
                                  name.capitalize.toString(), fontSize: 12,
                                  color: AppColors.blackColor)
                            ],
                          ).marginOnly(right: 30);
                        },
                    ...
                    Align(alignment: Alignment.centerLeft,
                        child: addText500('Popular Stations', fontSize: 16,
                            color: AppColors.blackColor)),
                    addHeight(12),
                    Column(
                      children: [
                          ...
                          return Stack(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  Get.toNamed(
                                      AppRoutes.customerStationDetailScreen);
                                },
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      addHeight(8),
                                      addText400(
                                          'Cars wash services', fontSize: 18,
                                          color: AppColors.blackColor),
                                      addText400('We have send the code.',
                                          fontSize: 13,
                                          color: AppColors.textColor1),


                                      addHeight(8), // date & time
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Image.asset(
                                                    AppAssets.locationNewIcon,
                                                    width: 20, height: 20),
                                                addWidth(4),
                                                addText400(
                                                    'Pune, India', fontSize: 13,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Image.asset(
                                                  AppAssets.stationDistanceIcon,
                                                  width: 20, height: 20),
                                              addWidth(4),
                                              addText400('0.5km', fontSize: 13,
                                                  color: AppColors.textColor3)
                                            ],
                                          ),
                                        ],
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.circular(
                                            25)),
                                    child: addText500('Book Now', fontSize: 16,
                                        color: AppColors.whiteColor)
                                        .marginSymmetric(
