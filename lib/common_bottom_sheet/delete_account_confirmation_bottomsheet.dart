            ...
            return BackdropFilter(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    addHeight(20),
                    Image.asset(AppAssets.deleteAccount,height: 60,width: 60,),
                    addHeight(4),
                    addText500('Are you sure you want to delete your Account', fontSize: 22,textAlign: TextAlign.center,height: 1.2),
                    Row(
