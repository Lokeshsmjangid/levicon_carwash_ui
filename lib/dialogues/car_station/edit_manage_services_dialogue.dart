...
class EditManageServicesDialog {
  static void show(BuildContext context,{void Function()? onTap}) {
    showDialog(
      context: context,
      barrierColor: AppColors.primaryColor.withOpacity(0.5),
      barrierDismissible: true,
      builder: (_) => EditManageServicesDialogWidget(onTap: onTap),
    );
  }
}

class EditManageServicesDialogWidget extends StatefulWidget {
  void Function()? onTap;

  EditManageServicesDialogWidget({this.onTap});

  @override
  State<EditManageServicesDialogWidget> createState() => _EditManageServicesDialogWidgetState();
}

class _EditManageServicesDialogWidgetState extends State<EditManageServicesDialogWidget> {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    addText600('Edit Service',fontSize: 18,color: AppColors.blackColor),
                    GestureDetector(
                        onTap: (){
                          Get.back();
                        },
                ...
                addText400('Per KM Price',fontSize: 14,color: AppColors.textColor3).marginOnly(bottom: 6,top: 6),
                CustomTextField(
                  keyboardType: TextInputType.number,
                  prefixIcon: addText400('₹',fontSize: 16,color: AppColors.primaryColor).marginOnly(left: 20),
                  hintText: 'Enter Amount',),addHeight(6),
                ...
                addText400('Time',fontSize: 14,color: AppColors.textColor3).marginOnly(bottom: 6,top: 6),
                CustomTextField(
                  hintText: '55 min',),
